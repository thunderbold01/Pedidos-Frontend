...
const DashboardAdministracao = ({ user, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'PENDENTE_DIRECAO', label: 'Meus Pendentes', icon: '🟡', destaque: true },
    ...
    <div style={styles.container}>
      ...
      <div style={{ ...styles.sidebar, left: menuMobile ? '0' : '-280px' }}>
        <div style={styles.sidebarHeader}>
          <div style={{ ...styles.avatar, backgroundColor: '#E91E63' }}>{user.nome?.charAt(0) || 'A'}</div>
          <div>
      ...
      <div style={styles.mainContent}>
        <div style={styles.statsBar}>
          ...
          <div style={styles.statItem}><span style={styles.statValue}>{stats.meus_pedidos_pendentes || 0}</span><span style={styles.statLabel}>Meus Pendentes</span></div>
          <div style={styles.statDivider} />
